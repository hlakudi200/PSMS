...
namespace psms.Migrations
{
    ...
    [Migration("20260923091659_AddReportRe002Fields")]
    partial class AddReportRe002Fields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("psms.Domain.Assessment.Entities.AssessmentWeighting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Band")
                        .IsUnique()
                        .HasDatabaseName("IX_AssessmentWeightings_TenantId_Band")
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("AssessmentWeightings");
                });
            ...
            modelBuilder.Entity("psms.Domain.Assessment.Entities.Report", b =>
                {
                    ...
                    b.Property<string>("BehaviourComments")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<int?>("DiligenceRating")
                        .HasColumnType("integer");
                    ...
                    b.Property<long?>("PrincipalSignedByUserId")
                        .HasColumnType("bigint");

                    b.Property<DateTime?>("PrincipalSignedDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<long?>("TeacherSignedByUserId")
                        .HasColumnType("bigint");

                    b.Property<DateTime?>("TeacherSignedDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("psms.Domain.Assessment.Entities.ReportSubject", b =>
                {
                    ...
                    b.Property<bool>("AwaitsExternalExamination")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("psms.Domain.Communication.Entities.NotificationConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("psms.Domain.Communication.Entities.NotificationDeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "IdempotencyKey", "Channel", "RecipientUserId")
                        .HasDatabaseName("IX_NotificationDeliveryLogs_Idempotency");

                    b.ToTable("NotificationDeliveryLogs");
                });

            modelBuilder.Entity("psms.Domain.Communication.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "Channel", "Category")
                        .IsUnique()
            ...
            modelBuilder.Entity("psms.Domain.Communication.Entities.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProviderParameterKeys")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("psms.Domain.Communication.Entities.UserDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("psms.Domain.Learning.Entities.LiveClassAttendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OnlineLessonId", "ParticipantIdentity")
                        .IsUnique()
            ...
            modelBuilder.Entity("psms.Domain.Tenancy.Entities.SchoolBranding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FaviconObjectKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("psms.Domain.Workflow.Entities.WorkflowStep", b =>
                {
                    ...
                    b.Property<string>("DecisionSchemaKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<string>("EntryEffectKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("ExitEffectKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("psms.Domain.Workflow.Entities.WorkflowTransition", b =>
                {
                    ...
                    b.Property<bool>("IsGuardOverridden")
                        .HasColumnType("boolean");
