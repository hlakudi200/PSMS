...
public abstract class psmsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static psmsWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(psmsWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<psmsDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<psmsDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<psmsDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<psmsDbContext, Task<T>> func)
    {
        T result;
